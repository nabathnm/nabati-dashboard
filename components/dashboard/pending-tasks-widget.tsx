...
const categoryStyles: Record<string, { bg: string; border: string }> = {
  Kuliah: { bg: "bg-blue-500/10 dark:bg-[#88c0d0]/20 text-blue-500 dark:text-[#88c0d0]", border: "border-blue-500/20 dark:border-[#88c0d0]/30" },
  Organisasi: { bg: "bg-yellow-500/10 dark:bg-[#ebcb8b]/20 text-yellow-500 dark:text-[#ebcb8b]", border: "border-yellow-500/20 dark:border-[#ebcb8b]/30" },
  Praktikum: { bg: "bg-rose-500/10 dark:bg-[#bf616a]/20 text-rose-500 dark:text-[#bf616a]", border: "border-rose-500/20 dark:border-[#bf616a]/30" },
  Lainnya: { bg: "bg-purple-500/10 dark:bg-[#b48ead]/20 text-purple-500 dark:text-[#b48ead]", border: "border-purple-500/20 dark:border-[#b48ead]/30" },
};
      ...
      <CardContent className="flex-1">
        {loading ? (
          ...
          <div className="h-full flex flex-col items-center justify-center text-center space-y-3 py-6">
            <div className="h-12 w-12 rounded-full bg-emerald-500/10 dark:bg-[#a3be8c]/20 flex items-center justify-center">
              <CheckCircle2 className="h-6 w-6 text-emerald-500 dark:text-[#a3be8c]" />
            </div>
            <div>
